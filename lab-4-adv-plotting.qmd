...
This will save your key to your R install. **For here on, you can run `sc_get()` to load your API key from memory**. You will need to re-run `sc_key()` whenever you restart R, so it may be helpful to save your key somewhere safe. Run the following code to get our data for today:
