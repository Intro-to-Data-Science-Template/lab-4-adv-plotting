...
If they get the facet by year, they will see the price increase over time. Otherwise they should talk about the separation of the class of unis, and how that relates to their cost/admission rate. Public are way less expensive and largely less selective, a few unis are hyper selective and expensive, for profit is very not selective (wild surprise), etc.  
:::
...
# They need to subset to just 2017 data somehow
